    ...
    <div className="bg-[#fdfdfd] min-h-screen">
      ...
      <main className="w-full px-3 sm:px-4 md:px-6 lg:px-8 pt-20">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 py-8 md:py-12">
          ...
          <div className="w-full lg:w-1/2 mt-8 lg:mt-0">
            <div className="relative w-full h-48 sm:h-64 md:h-80 lg:h-96 rounded-lg overflow-hidden shadow-lg group">
