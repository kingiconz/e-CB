...
const connectionString = process.env.DATABASE_URL || 'postgresql://postgres.ubwhbaeuafvhbibkvheh:ecrimemenuplanner@aws-1-eu-north-1.pooler.supabase.com:6543/postgres';
